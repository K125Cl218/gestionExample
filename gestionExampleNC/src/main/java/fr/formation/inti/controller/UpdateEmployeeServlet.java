...
public class UpdateEmployeeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Employee empUpdated = new Employee(dept, manager, endDate, firstName, lastName, startDate, title, assignedBranchId, null);
		empUpdated.setEmpId(empId);
		
		empService.EditEmployee(empUpdated);
